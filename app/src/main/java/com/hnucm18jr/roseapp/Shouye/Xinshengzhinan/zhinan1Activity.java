...
public class zhinan1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhinan1);
        ...
        mWebView.loadUrl("https://mp.weixin.qq.com/s/sbxEIXUUp3MowZoB_D3KdA");
